...
### Foreach image
for index in range(0, len(image_paths)-1):
...
# Visualize result for image 4
print(f"predicting image 4...")

result = get_results(image_paths[3], model)
cv.imshow("mask", result)
cv.waitKey(0)
cv.destroyAllWindows()

cv.imwrite(f"result/road4_cross_validation.png", result)
